...
SELECT r.id, NULL, 'patient.demo@hindcare.in', '+919876543210',
...
INSERT INTO customer_profiles (user_id, full_name, gender, date_of_birth, blood_group, height_cm, weight_kg)
SELECT u.id, 'Priya Sharma', 'female', '1992-05-15', 'B+', 162.0, 58.0
FROM users u JOIN roles r ON u.role_id = r.id WHERE r.slug = 'customer' AND u.email = 'patient.demo@hindcare.in';
